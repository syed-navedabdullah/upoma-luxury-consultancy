...
function Practice() {
  return (
    <>
      ...
      <section className="pb-32 md:pb-48">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 grid grid-cols-12 gap-12">
          ...
          <div className="col-span-12 md:col-span-5 order-1 md:order-2 space-y-8">
            <p className="text-xl md:text-2xl font-serif italic leading-relaxed text-emerald-deep">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8 border-t border-emerald-deep/10">
              <div>
                <p className="font-serif text-5xl text-emerald-deep">07</p>
                <p className="text-[10px] tracking-luxury uppercase text-muted-foreground mt-2">Engagements / year</p>
              </div>
              <div>
                <p className="font-serif text-5xl text-emerald-deep">42</p>
                <p className="text-[10px] tracking-luxury uppercase text-muted-foreground mt-2">Partners since 2019</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 md:py-40 bg-silk/40">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <SectionLabel index="01">The Atelier</SectionLabel>
          <h2 className="mt-8 mb-16 font-serif text-4xl md:text-6xl text-emerald-deep max-w-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
            {[
              ...
              <div key={p.name}>
                ...
                <h3 className="font-serif text-3xl italic text-emerald-deep mb-3">{p.name}</h3>
